 ...
 * Quiz Controller
 */
class QuizControllerResponse extends JControllerForm
{
	    function export()
    {
		
		$db =& JFactory::getDBO();
		$query = ' SELECT id , content, valeur, id_question' . ' FROM #__reponse';
        $db->setQuery($query);
		...
		$separator = '";"';
		$after = '"';
		$exportFields = array("ID" , "CONTENT", "VALEUR", "ID_QUESTION" );
